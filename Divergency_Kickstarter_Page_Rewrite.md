...
| Fast brawler readability, team fights, simple controls, and special moves that create memorable chaos. | Large fights, ally pressure, clear attacks, and character actions that stay readable when the screen gets busy. | Character variety, match-up experimentation, and the feeling that every fighter can have a different rhythm. |
...
| Stage | Region | Focus |
| --- | --- | --- |
| Stage 1 | Marseille | Prison escape, undercity routes, gangs, secret police, research submarine |
| Stage 2 | Sakuri | Sacred paths, hidden doors, identity, family, and the fragment called The Ear |
| Stage 3 | Calvaria | Grave-city, old wars, false comfort, and the voices of the dead |
...
![Bamboo forest route with command HUD](<imgs/Stage2/bamboo_forest_HUD_AI.png>)

![Calvaria route](<imgs/Stage3/dusk_haeven.png>)

## Current Development Status

Divergency is in active development from a playable build.

Already built or in progress:

- Five playable main characters.
- Core 2D/2.5D movement and beat 'em up combat.
- Skill loadout structure and mission selection UI direction.
- Player-to-AI squad command prototype.
- Enemy behavior, encounter logic, and boss encounter tests.
- Marseille sewer, undercity, laboratory, and industrial environment art.
- Stage 1 story structure covering Bastonne, Armorlite, Laundel, the port ambush, and the research submarine.
- Full campaign outline for Sakuri, Calvaria, Akam Meskul, and The Cradle.
- Combat HUD, command controls, skill selection, and character selection UI direction.

Still to finish:

- Combat polish, hit timing, balancing, and boss tuning.
- Final UI art, menu flow, and release-ready presentation.
- Full stage implementation across the campaign.
- Final music, sound effects, VFX polish, localization pass, and QA.
- Backer reward production and delivery.
- Stretch-goal modes and online features, only if those goals are reached and testing supports them.
...
| --- | ---: | --- |
| Gameplay programming and production | 45% | Combat polish, skill selection, squad commands, enemy logic, stage flow, tools, and release work |
| Pixel art, animation, backgrounds, VFX | 25% | Characters, enemies, bosses, stage environments, effects, and campaign polish |
| Music and sound effects | 10% | Combat impact, ambience, UI sound, and campaign music |
| QA, community, and launch materials | 8% | Testing, feedback passes, store assets, backer updates, and launch preparation |
...
![Divergency funding goals roadmap](<imgs/UI/funding-goals-khoa-style-game-bg.png>)
...
| Month 1-3 | Combat polish pass, clean gameplay capture, UI direction lock, production tools |
| Month 4-6 | Stage 1 vertical slice: Bastonne, Marseille route flow, enemies, and first boss structure |
| Month 7-10 | Stage 1 content build: Armorlite, Laundel, port ambush, submarine laboratory, and major experiment boss |
...
- Use a project image that reads clearly at small size and behind Kickstarter's play button.
